...
#' the input_default is then returned.
#'
...
#' as the regular output of get_ontology. The `count`` is represented by the
#' number of genes, the `term` provides the message and `set_label` provides
#' the label of the gene set for which a condition was encountered.
#'
